...
var s_account = "intrawestwp-trestle"
...
s.linkInternalFilters="javascript:,trestlebikepark.com"
...
function s_doPlugins(s) {
	...
	/* Plugin: getQueryParam v2.0*/
	s.campaign=s.getQueryParam('campaignid','cid');
	//s.eVar1=s.getQueryParam('source_id');
	s.eVar3=s.getQueryParam('itc');
	s.eVar4=s.getQueryParam('etc');
	s.eVar5=s.getQueryParam('crmcontact');
	s.eVar6=s.getQueryParam('ibar');
	s.eVar12=s.getQueryParam('crmldg');
	s.eVar13=s.getQueryParam('crmlpr');
	s.eVar14=s.getQueryParam('crmlps');
	s.eVar15=s.getQueryParam('crmpas');
	s.eVar16=s.getQueryParam('crmsnr');
	s.eVar17=s.getQueryParam('crmnws');
	s.eVar18=s.getQueryParam('crmxr');
	s.eVar19=s.getQueryParam('crmunc');
	s.eVar24=s.getQueryParam('campaignid');
	s.eVar=s.getQueryParam('');	
...
s.trackingServer="rezrez.112.2o7.net"
